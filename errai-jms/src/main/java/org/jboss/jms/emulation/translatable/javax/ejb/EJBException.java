...
/**
 * The EJBException is thrown to report that the invoked business method or callback method could not be completed because of an
...
public class EJBException extends java.lang.RuntimeException {
    ...
    /**
     * Obtain the exception that caused the EJBException to be thrown. It is recommended that the inherited Throwable.getCause()
     * method be used to retrieve the cause instead of this method.
     */
