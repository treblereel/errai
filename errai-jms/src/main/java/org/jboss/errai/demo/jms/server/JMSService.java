...
public class JMSService {
  ...
  public void sendTextMessangeQueue() {
    ...
    jMSProducer.setProperty("forLabel", "sendTextMessageQueue");
  ...
  public void sendTextMessangeTopic() {
    ...
    jMSProducer.setProperty("boolean", false);
    jMSProducer.setProperty("string", "string");
    jMSProducer.setProperty("forLabel", "sendTextMessageTopic");
  ...
  public void sendObjectMessageQueue() {
    ...
    jMSProducer.setProperty("boolean", false);
    jMSProducer.setProperty("string", "string");
    jMSProducer.setProperty("forLabel", "sendObjectMessageQueue");
  ...
  public void sendByteMessageQueue() {
    ...
    jMSProducer.setProperty("boolean", false);
    jMSProducer.setProperty("string", "string");
    jMSProducer.setProperty("forLabel", "sendByteMessageQueue");
  ...
  public void sendMapMessageQueue() {
    ...
    jMSProducer.setProperty("boolean", false);
    jMSProducer.setProperty("string", "string");
    jMSProducer.setProperty("forLabel", "sendMapMessageQueue");
