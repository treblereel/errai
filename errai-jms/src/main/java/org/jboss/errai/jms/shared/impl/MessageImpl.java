...
public class MessageImpl implements Serializable, Message {
  ...
  /**
   * cannot support private field marshalling of long type (not supported by
   * JSNI) for field: org.jboss.errai.jms.shared.impl.MessageImpl#jMSTimestamp
   */
  ...
  public MessageImpl(Message message) {
    try {
      ...
      for (Enumeration<String> props = message.getPropertyNames(); props
              .hasMoreElements();) {
  ...
  public boolean isBodyAssignableTo(Class c) throws JMSException {
     ...
     * From the specs:
     * <p>
     * If the message is a {@code Message} (but not one of its subtypes) then
   ...
   * @throws JMSException
   */
  private Destination toDestination(Destination destination)
          throws JMSException {
