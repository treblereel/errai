...
public class MessageDrivenBeanConfiguration {
    ...
    public MessageDrivenBeanConfiguration(Decorable decorable) {
        ...
        MessageDriven annotation = decorable.getDecorableDeclaringType().getAnnotation(MessageDriven.class);
        ...
        for (ActivationConfigProperty activationConfig : annotation.activationConfig()) {
        ...
        this.setClassName(decorable.getDecorableDeclaringType().asClass().getSimpleName());
    ...
    /**
     * Because there are could be several beans with the same name, we will add a random string to the generated bean name
     * 
